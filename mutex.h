...
namespace Lunaris {
	...
	/// </summary>
	class fast_one_way_mutex {
		bool slave_ack = false;
		bool request_stop = false;
	public:
		fast_one_way_mutex() = default;
		fast_one_way_mutex(fast_one_way_mutex&&) = delete;
		fast_one_way_mutex(const fast_one_way_mutex&) = delete;
		void operator=(fast_one_way_mutex&&) = delete;
		void operator=(const fast_one_way_mutex&) = delete;
	...
	/// </summary>
	class fast_lock_guard {
		fast_one_way_mutex& ref;
	public:
		fast_lock_guard(fast_lock_guard&&) = delete;
		fast_lock_guard(const fast_lock_guard&) = delete;
		void operator=(fast_lock_guard&&) = delete;
		void operator=(const fast_lock_guard&) = delete;
